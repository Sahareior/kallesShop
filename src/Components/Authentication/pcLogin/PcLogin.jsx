...
const PcLogin = () => {
    ...
    console.log(location.state?.state?.pathname)
    const handleGoogle =()=>{
        ...
        <div className="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0 bg-[#161616]" >
            ...
            <div className="w-full py-6 z-20">
                ...
                <div className="py-6 space-x-2">
                    ...
                    <span onClick={()=>handleGoogle()} className="w-10 hover:bg-slate-400 hover:cursor-pointer h-10 items-center justify-center inline-flex rounded-full font-bold text-lg border-2 border-white">G</span>
                ...
                <p className="text-gray-100 text-xl">
                    Have a google account? click the icon
                </p>
                <form onSubmit={handleLogin} className="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                    ...
                    <div className=" text-gray-400  flex justify-between mt-3 hover:text-gray-100">
                        <a className='text-red-600 text-lg' href="#">Forgot your password?</a>
                        <Link to='/reg' className='text-lg' >Create an Account</Link>
                    </div>
